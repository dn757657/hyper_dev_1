...
urlpatterns = [
    ...
    path("ecommerce/customers", view=apps_ecommerce_customers_view,
         name="ecommerce.customers"),
    path("ecommerce/orders-details", view=apps_ecommerce_orders_details_view,
         name="ecommerce.orders-details"),
    path("ecommerce/orders", view=apps_ecommerce_orders_view,
         name="ecommerce.orders"),
    path("ecommerce/products-details", view=apps_ecommerce_products_details_view,
    ...
    path("ecommerce/shopping-cart", view=apps_ecommerce_shopping_cart_view,
    ...
    path("projects/details", view=apps_projects_details_view,
